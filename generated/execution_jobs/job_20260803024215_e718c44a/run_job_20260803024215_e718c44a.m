try
  addpath('D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260803024215_e718c44a');
  ...
  model = generated_build_one_dimensional_axial_bar();
  % Re-run mesh and study here so result export always targets a solved dataset.
  model.component('comp1').mesh('mesh1').run;
  model.study('std1').run;
  mphsave(model, 'D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260803024215_e718c44a/job_20260803024215_e718c44a.mph');
  output_names = {'u_max', 'mises_max'};
  output_expressions = {'maxop1(solid.disp)', 'maxop1(solid.mises)'};
  results_file = 'D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260803024215_e718c44a/job_20260803024215_e718c44a_results.csv';
