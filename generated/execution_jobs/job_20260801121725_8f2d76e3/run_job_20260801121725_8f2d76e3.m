try
  addpath('D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260801121725_8f2d76e3');
  ...
  model = generated_build_one_dimensional_heat_conduction();
  % Re-run mesh and study here so result export always targets a solved dataset.
  model.component('comp1').mesh('mesh1').run;
  model.study('std1').run;
  mphsave(model, 'D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260801121725_8f2d76e3/job_20260801121725_8f2d76e3.mph');
  output_names = {'T_max'};
  output_expressions = {'maxop1(T)'};
  output_values = mphglobal(model, output_expressions);
  results_file = 'D:/桌面/codex/comsol1/comsol_training_small_model/generated/execution_jobs/job_20260801121725_8f2d76e3/job_20260801121725_8f2d76e3_results.csv';
  ...
  for output_index = 1:numel(output_names)
    fprintf(results_fid, '%s,\"%s\",%.16g\n', output_names{output_index}, output_expressions{output_index}, output_values(output_index));
  end
  fclose(results_fid);
