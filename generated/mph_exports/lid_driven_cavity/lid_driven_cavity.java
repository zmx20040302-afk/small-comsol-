...
public class lid_driven_cavity {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model
         .modelPath("D:\\\u684c\u9762\\codex\\\u6848\u4f8b\u4e0b\u8f7d\\COMSOL\\\u9876\u76d6\u9a71\u52a8\u65b9\u8154\u6d41");
    ...
    model.component("comp1").physics("spf").prop("PhysicalModelProperty")
         .set("textCompressibilityMixtureModel", "The Mixture Model multiphysics coupling is restricted to incompressible flow");
    model.component("comp1").physics("spf").prop("PhysicalModelProperty")
         .set("textCompressibilityMixtureModel2", "The Incompressible flow option is not available for the Mixture Model multiphysics coupling");
    ...
    model.study("std1").feature("stat").set("pname", new String[]{"Re"});
    model.study("std1").feature("stat").set("plistarr", new String[]{"100 400 1000 3200 5000 7500 10000"});
    model.study("std1").feature("stat").set("punit", new String[]{""});

    model.batch().label("Batch");

    model.sol("sol1").label("Solution 1");
    model.sol("sol1").feature("st1").label("\u7f16\u8bd1\u65b9\u7a0b: Stationary");
    model.sol("sol1").feature("v1").label("Dependent Variables 1");
    model.sol("sol1").feature("v1").set("clistctrl", new String[]{"p1"});
    model.sol("sol1").feature("v1").set("cname", new String[]{"Re"});
    model.sol("sol1").feature("v1").set("clist", new String[]{"100 400 1000 3200 5000 7500 10000"});
    ...
    model.sol("sol1").feature("s1").feature("p1").set("pname", new String[]{"Re"});
    model.sol("sol1").feature("s1").feature("p1").set("plistarr", new String[]{"100 400 1000 3200 5000 7500 10000"});
    ...
    model.result().dataset("cln1").set("genpoints", new String[][]{{".5", "0"}, {".5", "1"}});
    model.result().dataset("cln2").label("Cut Line 2D 2");
    model.result().dataset("cln2").set("genpoints", new String[][]{{"0", ".5"}, {"1", ".5"}});
