...
- Created at: `2026-07-06T09:38:18.027966+00:00`
...
- `mesh_from_scanned_data_helmholtz.mph`: 参数=1, 几何=3, 物理场=1, 研究=0, 结果=0
...
- Simple summary: 基于扫描数据生成可供仿真的网格 主要研究模型中的主要物理现象和输出量，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Coefficient Form PDE。
...
- Sweep `R` around the learned value `0.0001` and export target outputs to CSV.
