...
- `radially_polarized_piezo_63.java`: 参数=0, 几何=7, 物理场=1, 研究=0, 结果=0
- `radially_polarized_piezo_63.m`: 参数=0, 几何=7, 物理场=0, 研究=0, 结果=0
- `radially_polarized_piezo_63.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `radially_polarized_piezo_63.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `radially_polarized_piezo_63_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: radially_polarized_piezo_63 主要研究电流、电势或电磁场分布，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Solid Mechanics。
...
- Summary: 已学习 radially_polarized_piezo_63 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=16 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：radially_polarized_piezo_63.m, radially_polarized_piezo_63.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 radially_polarized_piezo_63，训练阶段为 modeling_logic_learning_ready。
...
- `radially_polarized_piezo_63.mph` (comsol_mph, 1232730 bytes)
- `radially_polarized_piezo_63.m` (matlab_livelink, 27621 bytes)
- `radially_polarized_piezo_63.java` (comsol_java, 29389 bytes)
- `radially_polarized_piezo_63_summary.json` (json, 1021 bytes)
