...
- Created at: `2026-08-22T04:45:57.562546+00:00`
...
- `surface_micromachined_accelerometer.java`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mems.surface_micromachined_accelerometer.pdf`: 参数=0, 几何=0, 物理场=2, 研究=1, 结果=0
- `surface_micromachined_accelerometer.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `surface_micromachined_accelerometer_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `surface_micromachined_accelerometer.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: surface_micromachined_accelerometer 主要研究流动速度、压力或输运过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Solid Mechanics，并采用 Stationary 研究。
...
- Summary: 已学习 surface_micromachined_accelerometer 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=34；内容证据=34 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：surface_micromachined_accelerometer.m, surface_micromachined_accelerometer.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 surface_micromachined_accelerometer，训练阶段为 modeling_logic_learning_ready。
...
- `surface_micromachined_accelerometer.mph` (comsol_mph, 246286006 bytes)
- `surface_micromachined_accelerometer.m` (matlab_livelink, 81737 bytes)
- `surface_micromachined_accelerometer.java` (comsol_java, 83708 bytes)
- `surface_micromachined_accelerometer_summary.json` (json, 2252 bytes)
