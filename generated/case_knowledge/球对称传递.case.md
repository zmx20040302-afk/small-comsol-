...
- Created at: `2026-06-29T08:47:12.096590+00:00`
...
- `spherically_symmetric_transport.java`: 参数=8, 几何=1, 物理场=1, 研究=2, 结果=2
- `spherically_symmetric_transport.m`: 参数=8, 几何=1, 物理场=1, 研究=1, 结果=2
...
- `spherically_symmetric_transport.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 球对称传递 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=8；内容证据=31 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 31 条；几何=1，物理场=1，材料=0，网格=4，研究=2，结果=2。
