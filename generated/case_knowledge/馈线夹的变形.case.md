...
- Created at: `2026-06-29T08:51:26.066701+00:00`
...
- `feeder_clamp.java`: 参数=2, 几何=12, 物理场=1, 研究=2, 结果=0
- `feeder_clamp.m`: 参数=2, 几何=11, 物理场=1, 研究=1, 结果=0
- `feeder_clamp.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 馈线夹的变形 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=2；内容证据=30 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 30 条；几何=12，物理场=1，材料=0，网格=1，研究=2，结果=0。
