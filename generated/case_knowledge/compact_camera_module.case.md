...
- Created at: `2026-08-22T05:00:19.942706+00:00`
...
- `compact_camera_module.java`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.roptics.compact_camera_module.pdf`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `compact_camera_module.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `compact_camera_module.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `compact_camera_module_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: compact_camera_module 主要研究温度场和热传递过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer。
...
- Summary: 已学习 compact_camera_module 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=33；内容证据=31 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：compact_camera_module.m, compact_camera_module.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 compact_camera_module，训练阶段为 modeling_logic_learning_ready。
...
- `compact_camera_module.mph` (comsol_mph, 92097784 bytes)
- `compact_camera_module.m` (matlab_livelink, 67155 bytes)
- `compact_camera_module.java` (comsol_java, 66361 bytes)
- `compact_camera_module_summary.json` (json, 4194 bytes)
