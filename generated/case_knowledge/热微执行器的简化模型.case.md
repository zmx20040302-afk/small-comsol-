...
- Created at: `2026-06-29T08:46:32.727411+00:00`
...
- `thermal_actuator_simplified.java`: 参数=16, 几何=5, 物理场=3, 研究=2, 结果=0
- `thermal_actuator_simplified.m`: 参数=16, 几何=5, 物理场=3, 研究=1, 结果=0
...
- `thermal_actuator_simplified.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 热微执行器的简化模型 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=16；内容证据=31 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 31 条；几何=5，物理场=3，材料=0，网格=1，研究=2，结果=0。
