...
- Created at: `2026-06-29T08:45:10.631860+00:00`
...
- `busbar.m`: 参数=7, 几何=6, 物理场=2, 研究=1, 结果=0
- `busbar_box.java`: 参数=7, 几何=7, 物理场=2, 研究=2, 结果=0
- `busbar_box.m`: 参数=7, 几何=6, 物理场=2, 研究=1, 结果=0
- `busbar_geom.m`: 参数=7, 几何=6, 物理场=2, 研究=1, 结果=0
- `busbar.java`: 参数=7, 几何=6, 物理场=2, 研究=2, 结果=0
- `busbar_geom.java`: 参数=7, 几何=6, 物理场=2, 研究=2, 结果=0
- `busbar.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `busbar.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `busbar_box.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `busbar_box.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `busbar_geom.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 母线板焦耳热 的 15 个文件；训练阶段=modeling_logic_learning_ready；参数数量=7；内容证据=24 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 24 条；几何=7，物理场=2，材料=0，网格=1，研究=2，结果=0。
