...
- Created at: `2026-06-29T08:44:10.548098+00:00`
...
- `micromixer_batch.java`: 参数=6, 几何=0, 物理场=2, 研究=2, 结果=0
- `micromixer_batch.m`: 参数=6, 几何=0, 物理场=2, 研究=1, 结果=0
- `micromixer_batch.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 微混合器 - 批处理和集群版本 的 10 个文件；训练阶段=modeling_logic_learning_ready；参数数量=6；内容证据=12 条。
