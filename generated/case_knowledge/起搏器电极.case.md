...
- Created at: `2026-06-29T08:49:49.819775+00:00`
...
- `pacemaker_electrode.java`: 参数=0, 几何=7, 物理场=1, 研究=2, 结果=1
- `pacemaker_electrode.m`: 参数=0, 几何=7, 物理场=1, 研究=1, 结果=1
...
- `pacemaker_electrode.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `pacemaker_electrode.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `pacemaker_electrode_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 起搏器电极 的 10 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=56 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 56 条；几何=25，物理场=1，材料=1，网格=1，研究=2，结果=1。
