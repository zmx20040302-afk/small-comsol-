...
- Created at: `2026-06-29T08:45:04.646186+00:00`
...
- `mandelbrot_set.java`: 参数=2, 几何=4, 物理场=0, 研究=2, 结果=3
- `mandelbrot_set.m`: 参数=2, 几何=4, 物理场=0, 研究=1, 结果=3
- `perlin_noise.java`: 参数=4, 几何=2, 物理场=0, 研究=0, 结果=0
- `perlin_noise.m`: 参数=4, 几何=2, 物理场=0, 研究=0, 结果=0
- `mandelbrot_set.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `perlin_noise.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 曼德勃罗集和柏林噪声 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=5；内容证据=37 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 37 条；几何=6，物理场=0，材料=0，网格=4，研究=2，结果=3。
