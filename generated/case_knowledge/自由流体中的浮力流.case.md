...
- Created at: `2026-06-29T08:49:12.285599+00:00`
...
- `buoyancy_free.java`: 参数=5, 几何=1, 物理场=2, 研究=2, 结果=0
- `buoyancy_free.m`: 参数=5, 几何=1, 物理场=2, 研究=1, 结果=0
- `buoyancy_free.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 自由流体中的浮力流 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=5；内容证据=37 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 37 条；几何=1，物理场=2，材料=0，网格=1，研究=2，结果=0。
