...
- Created at: `2026-06-29T08:51:13.534440+00:00`
...
- `lid_driven_cavity.java`: 参数=7, 几何=1, 物理场=1, 研究=2, 结果=0
- `lid_driven_cavity.m`: 参数=7, 几何=1, 物理场=1, 研究=1, 结果=0
- `lid_driven_cavity.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 顶盖驱动方腔流 的 9 个文件；训练阶段=modeling_logic_learning_ready；参数数量=7；内容证据=26 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 26 条；几何=1，物理场=1，材料=1，网格=2，研究=2，结果=0。
