...
- Case directory: `D:\桌面\codex\案例下载\COMSOL\KdV 方程和孤子`
- Training stage: `needs_comsol_sweep_csv`
- Created at: `2026-07-06T09:36:16.884919+00:00`
...
- `kdv_equation.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `kdv_equation.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.kdv_equation.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.kdv_equation.zh_CN.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0

## 每个 PDF 文件的简单总结

- `models.mph.kdv_equation.pdf`: models.mph.kdv_equation.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.kdv_equation.zh_CN.pdf`: models.mph.kdv_equation.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.

## PDF Summary and Physics Judgement

- Simple summary: KdV 方程和孤子 的 PDF 可用于理解案例目的、假设和操作步骤；当前证据还不足以唯一确定物理场，后续应结合 MATLAB/Java 中的 physics.create 或 COMSOL 模型树再确认。
...
- PDF keywords: models.mph.kdv_equation.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber., models.mph.kdv_equation.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
...
- Summary: 已学习 KdV 方程和孤子 的 4 个文件；训练阶段=needs_comsol_sweep_csv；参数数量=0；内容证据=0 条。
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 KdV 方程和孤子，训练阶段为 needs_comsol_sweep_csv。
...
- `LiveLinkForMATLABUsersGuide.pdf` page 198; module=LiveLink_for_MATLAB; score=0.1169
- `LiveLinkForSimulinkUsersGuide.pdf` page 20; module=LiveLink_for_Simulink; score=0.1152
- `COMSOL_ProgrammingReferenceManual.pdf` page 1196; module=COMSOL_Multiphysics; score=0.1113
...
- `kdv_equation.mph` (comsol_mph, 9418739 bytes)
- `kdv_equation.zh_CN.mph` (comsol_mph, 9433737 bytes)
- `models.mph.kdv_equation.pdf` (pdf_document, 326864 bytes)
- `models.mph.kdv_equation.zh_CN.pdf` (pdf_document, 524706 bytes)
