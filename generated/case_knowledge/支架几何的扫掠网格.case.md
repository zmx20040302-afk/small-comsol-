...
- Created at: `2026-06-29T08:44:48.638264+00:00`
...
- results: pg1, mesh1
- boundary_conditions: imp1 / filename, swe1 / element, pard1 / partitionwith, size / hauto, size / custom, size / hmax, dis1 / numelem, mesh1 / colortable, mesh1 / colortabletrans, mesh1 / nonlinearcolortablerev, mesh1 / meshdomain

### 文件内容证据

- `bracket_swept_mesh.java`: 参数=0, 几何=5, 物理场=0, 研究=0, 结果=2
- `bracket_swept_mesh.m`: 参数=0, 几何=5, 物理场=0, 研究=0, 结果=2
- `bracket_swept_mesh.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 支架几何的扫掠网格 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=24 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 24 条；几何=5，物理场=0，材料=0，网格=6，研究=0，结果=2。
