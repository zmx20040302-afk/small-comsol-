# zernike_deformed_surface_fitting

- Case directory: `D:\桌面\codex\案例下载\COMSOL\变形曲面的泽尼克多项式拟合`
- Training stage: `modeling_logic_learning_ready`
- Created at: `2026-06-29T03:09:56.362468+00:00`
...
- Summary: Learned 3 files for zernike_deformed_surface_fitting; stage=modeling_logic_learning_ready; parameters=4.
...
- **2. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：deformed_mirror_zernike_fitting.java, deformed_mirror_zernike_fitting.m
...
- **6. 记忆库补充**
  - Evidence: 案例标题为 zernike_deformed_surface_fitting，训练阶段为 modeling_logic_learning_ready。
...
- `使用 Microsoft® Azure 运行 COMSOL® 软件` score=0.1282; fields=topic only; parameters=0
- `通过 Amazon EC2™ 运行 COMSOL® 软件` score=0.1116; fields=topic only; parameters=0
- `热执行器代理模型 App` score=0.0872; fields=physics, geometry, materials, boundary_conditions, mesh, solver, results; parameters=42

### Official Documentation Checks

- `COMSOL_ReferenceManual.pdf` page 1591; module=COMSOL_Multiphysics; score=0.1721
- `COMSOL_ReferenceManual.pdf` page 1597; module=COMSOL_Multiphysics; score=0.1688
- `COMSOL_ProgrammingReferenceManual.pdf` page 1196; module=COMSOL_Multiphysics; score=0.1651
...
- `deformed_mirror_zernike_fitting.java` (comsol_java, 85260 bytes)
- `deformed_mirror_zernike_fitting.m` (matlab_livelink, 79730 bytes)
- `deformed_mirror_zernike_fitting.mph` (comsol_mph, 6774160 bytes)
