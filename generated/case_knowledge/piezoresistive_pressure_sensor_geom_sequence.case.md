...
- `piezoresistive_pressure_sensor_geom_sequence.java`: 参数=0, 几何=6, 物理场=0, 研究=0, 结果=0
- `piezoresistive_pressure_sensor_geom_sequence.m`: 参数=0, 几何=5, 物理场=0, 研究=0, 结果=0
...
- `piezoresistive_pressure_sensor_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `piezoresistive_pressure_sensor_geom_sequence_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: piezoresistive_pressure_sensor_geom_sequence 主要研究流动速度、压力或输运过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Stationary 研究。
...
- Summary: 已学习 piezoresistive_pressure_sensor_geom_sequence 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=27 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：piezoresistive_pressure_sensor_geom_sequence.m, piezoresistive_pressure_sensor_geom_sequence.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 piezoresistive_pressure_sensor_geom_sequence，训练阶段为 modeling_logic_learning_ready。
...
- `piezoresistive_pressure_sensor_geom_sequence.mph` (comsol_mph, 1252189 bytes)
- `piezoresistive_pressure_sensor_geom_sequence.m` (matlab_livelink, 18041 bytes)
- `piezoresistive_pressure_sensor_geom_sequence.java` (comsol_java, 18779 bytes)
- `piezoresistive_pressure_sensor_geom_sequence_summary.json` (json, 684 bytes)
