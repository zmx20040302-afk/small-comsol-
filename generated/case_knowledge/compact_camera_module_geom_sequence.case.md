# compact_camera_module_geom_sequence

- Case directory: `D:\桌面\codex\案例下载\电气\微型相机模组`
- Training stage: `modeling_logic_learning_ready`
- Created at: `2026-08-22T04:59:52.891726+00:00`
...
- `A_norm` = `1[mm]` - Aspheric normalization unit
- `d0_S` = `5.000[mm]` - Stop, outer diameter
- `d1_S` = `2.505[mm]` - Stop, inner diameter (oversized)
- `R1_1` = `1.679[mm]` - Lens 1, radius of curvature, surface 1
- `R2_1` = `-9.162[mm]` - Lens 1, radius of curvature, surface 2
- `K1_1` = `0.22669364` - Lens 1, conic constant, surface 1
- `K2_1` = `0` - Lens 1, conic constant, surface 1
- `A1_1` = `9.80281e-03` - Lens 1, 4th order aspheric term, surface 1
- `B1_1` = `-3.81227e-02` - Lens 1, 6th order aspheric term, surface 1
- `C1_1` = `2.39681e-02` - Lens 1, 8th order aspheric term, surface 1
- `D1_1` = `-6.29128e-03` - Lens 1, 10th order aspheric term, surface 1
- `E1_1` = `-2.75496e-03` - Lens 1, 12th order aspheric term, surface 1
- `F1_1` = `-2.69638e-04` - Lens 1, 14th order aspheric term, surface 1
- `A2_1` = `3.73187e-02` - Lens 1, 4th order aspheric term, surface 2
- `B2_1` = `-8.91760e-03` - Lens 1, 6th order aspheric term, surface 2
- `C2_1` = `-5.89384e-02` - Lens 1, 8th order aspheric term, surface 2
- `D2_1` = `4.41115e-02` - Lens 1, 10th order aspheric term, surface 2
- `E2_1` = `-1.26858e-02` - Lens 1, 12th order aspheric term, surface 2
- `F2_1` = `1.16125e-03` - Lens 1, 14th order aspheric term, surface 2
- `Tc_1` = `1.1080[mm]` - Lens 1, center thickness
- `d0_1` = `3.05[mm]` - Lens 1, outer diameter
- `d1_1` = `2.85[mm]` - Lens 1, surface 1 diameter
- `d2_1` = `0` - Lens 1, surface 2 diameter
- `T_1` = `0.1000[mm]` - Lens 1 to Lens 2 distance
- `R1_2` = `-15.649[mm]` - Lens 2, radius of curvature, surface 1
- `R2_2` = `3.482[mm]` - Lens 2, radius of curvature, surface 2
- `K1_2` = `0` - Lens 2, conic constant, surface 1
- `K2_2` = `8.70133393` - Lens 2, conic constant, surface 1
- `A1_2` = `6.93172e-02` - Lens 2, 4th order aspheric term, surface 1
- `B1_2` = `-4.31157e-02` - Lens 2, 6th order aspheric term, surface 1
- `C1_2` = `2.33346e-02` - Lens 2, 8th order aspheric term, surface 1
- `D1_2` = `-2.33074e-02` - Lens 2, 10th order aspheric term, surface 1
- `E1_2` = `2.22119e-02` - Lens 2, 12th order aspheric term, surface 1
- `F1_2` = `-4.84076e-03` - Lens 2, 14th order aspheric term, surface 1
- `A2_2` = `5.21579e-03` - Lens 2, 4th order aspheric term, surface 2
- `B2_2` = `7.15829e-02` - Lens 2, 6th order aspheric term, surface 2
- `C2_2` = `-4.60926e-02` - Lens 2, 8th order aspheric term, surface 2
...
- `compact_camera_module_geom_sequence.m`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `compact_camera_module_geom_sequence.java`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.roptics.compact_camera_module.pdf`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `compact_camera_module_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `compact_camera_module_geom_sequence_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0

## 每个 PDF 文件的简单总结

- `models.roptics.compact_camera_module.pdf`: models.roptics.compact_camera_module.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果，主要物理场线索为 Ray Optics；核心内容可概括为：Model created in COMSOL Multiphysics 6.4；geometry sequence (Figure 2) can be found in the Appendix — Geometry Instructions .

## PDF Summary and Physics Judgement

- Simple summary: compact_camera_module_geom_sequence 主要研究温度场和热传递过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer。
...
- PDF: geometry sequence (Figure 2) can be found in the Appendix — Geometry Instructions .
- PDF: In addition to the parameters used to define the Compact Camera Module geometry, a set
- PDF: of parameters are required to define the ray tracing model. These are listed in Table 2.
...
- PDF keywords: 传热, 结构力学, models.roptics.compact_camera_module.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果，主要物理场线索为 Ray Optics；核心内容可概括为：Model created in COMSOL Multiphysics 6.4；geometry sequence (Figure 2) can be found in the Appendix — Geometry Instructions .
...
- `A_norm` -> Aspheric normalization unit; MATLAB: `model.param.set('A_norm', value, description)`
- `d0_S` -> Stop, outer diameter; MATLAB: `model.param.set('d0_S', value, description)`
- `d1_S` -> Stop, inner diameter (oversized); MATLAB: `model.param.set('d1_S', value, description)`
- `R1_1` -> Lens 1, radius of curvature, surface 1; MATLAB: `model.param.set('R1_1', value, description)`
- `R2_1` -> Lens 1, radius of curvature, surface 2; MATLAB: `model.param.set('R2_1', value, description)`
- `K1_1` -> Lens 1, conic constant, surface 1; MATLAB: `model.param.set('K1_1', value, description)`
- `K2_1` -> Lens 1, conic constant, surface 1; MATLAB: `model.param.set('K2_1', value, description)`
- `A1_1` -> Lens 1, 4th order aspheric term, surface 1; MATLAB: `model.param.set('A1_1', value, description)`
- `B1_1` -> Lens 1, 6th order aspheric term, surface 1; MATLAB: `model.param.set('B1_1', value, description)`
...
- 已识别物理场证据：Ray Optics
- 已识别参数：nix、niy、niz、A_norm、d0_S、d1_S、R1_1、R2_1、K1_1、K2_1、A1_1、B1_1
...
- Sweep `A_norm` around the learned value `1[mm]` and export target outputs to CSV.
- Sweep `d0_S` around the learned value `5.000[mm]` and export target outputs to CSV.
- Sweep `d1_S` around the learned value `2.505[mm]` and export target outputs to CSV.
- Sweep `R1_1` around the learned value `1.679[mm]` and export target outputs to CSV.
- Sweep `R2_1` around the learned value `-9.162[mm]` and export target outputs to CSV.
...
- Summary: 已学习 compact_camera_module_geom_sequence 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=40；内容证据=31 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：compact_camera_module_geom_sequence.m, compact_camera_module_geom_sequence.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 compact_camera_module_geom_sequence，训练阶段为 modeling_logic_learning_ready。
...
- `compact_camera_module_geom_sequence.mph` (comsol_mph, 29995662 bytes)
- `compact_camera_module_geom_sequence.m` (matlab_livelink, 44864 bytes)
- `compact_camera_module_geom_sequence.java` (comsol_java, 47038 bytes)
- `compact_camera_module_geom_sequence_summary.json` (json, 3485 bytes)
- `models.roptics.compact_camera_module.pdf` (pdf_document, 1770429 bytes)
