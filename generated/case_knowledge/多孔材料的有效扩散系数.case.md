...
- Created at: `2026-07-06T09:38:23.214386+00:00`
...
- `effective_diffusivity_geom_sequence.mph`: 参数=0, 几何=17, 物理场=0, 研究=0, 结果=0
...
- `models.mph.effective_diffusivity.pdf`: models.mph.effective_diffusivity.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.effective_diffusivity.zh_CN.pdf`: models.mph.effective_diffusivity.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.

## PDF Summary and Physics Judgement

- Simple summary: 多孔材料的有效扩散系数 主要研究温度场和热传递过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Transient 研究。
...
- 脚本/文本识别到的物理场: tds / DilutedSpecies
...
- PDF keywords: 传热, models.mph.effective_diffusivity.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber., models.mph.effective_diffusivity.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `D2` -> 案例参数/扫描变量; MATLAB: `model.param.set('D2', value, description)`
- `c_max` -> 案例参数/扫描变量; MATLAB: `model.param.set('c_max', value, description)`
- `k_f` -> 案例参数/扫描变量; MATLAB: `model.param.set('k_f', value, description)`
...
- 已识别物理场证据：tds / DilutedSpecies
- 已识别参数：D2、c_max、k_f、a
...
- Transfer recognized physics interfaces to similar requirements: tds / DilutedSpecies.
