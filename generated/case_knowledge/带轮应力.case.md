...
- Created at: `2026-06-29T08:43:34.245661+00:00`
...
- `stresses_in_pulley.java`: 参数=8, 几何=3, 物理场=1, 研究=2, 结果=0
- `stresses_in_pulley.m`: 参数=8, 几何=3, 物理场=1, 研究=1, 结果=0
...
- `stresses_in_pulley.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 带轮应力 的 10 个文件；训练阶段=modeling_logic_learning_ready；参数数量=8；内容证据=18 条。
