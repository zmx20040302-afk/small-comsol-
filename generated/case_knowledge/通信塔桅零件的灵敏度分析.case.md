...
- Created at: `2026-06-29T08:50:31.559436+00:00`
...
- `mast_diagonal_mounting_sensitivity.java`: 参数=1, 几何=0, 物理场=1, 研究=2, 结果=0
- `mast_diagonal_mounting_sensitivity.m`: 参数=1, 几何=0, 物理场=1, 研究=1, 结果=0
- `mast_diagonal_mounting_sensitivity.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 通信塔桅零件的灵敏度分析 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=1；内容证据=6 条。
