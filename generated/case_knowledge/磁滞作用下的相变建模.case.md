...
- Created at: `2026-06-29T08:48:26.942162+00:00`
...
- `thermal_hysteresis_using_state_variables_v62.java`: 参数=7, 几何=5, 物理场=1, 研究=2, 结果=0
- `thermal_hysteresis_v62.java`: 参数=7, 几何=5, 物理场=1, 研究=2, 结果=0
- `thermal_hysteresis_using_state_variables_v62.m`: 参数=7, 几何=5, 物理场=1, 研究=1, 结果=0
- `thermal_hysteresis_v62.m`: 参数=7, 几何=5, 物理场=1, 研究=1, 结果=0
...
- Summary: 已学习 磁滞作用下的相变建模 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=7；内容证据=29 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 29 条；几何=5，物理场=1，材料=1，网格=1，研究=2，结果=0。
