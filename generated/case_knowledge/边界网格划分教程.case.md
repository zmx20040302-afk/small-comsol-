...
- Created at: `2026-07-06T09:45:01.184056+00:00`
...
- `models.mph.valve_boundary_layers.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.valve_boundary_layers.zh_CN.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.valve_boundary_layers_import.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.valve_boundary_layers_import.zh_CN.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_boundary_layers.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_boundary_layers.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_boundary_layers_import.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_boundary_layers_import.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_boundary_layers_mapped.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `valve_geom_sequence.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0

## 每个 PDF 文件的简单总结

- `models.mph.valve_boundary_layers.pdf`: models.mph.valve_boundary_layers.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.valve_boundary_layers.zh_CN.pdf`: models.mph.valve_boundary_layers.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.valve_boundary_layers_import.pdf`: models.mph.valve_boundary_layers_import.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.valve_boundary_layers_import.zh_CN.pdf`: models.mph.valve_boundary_layers_import.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.

## PDF Summary and Physics Judgement

- Simple summary: 边界网格划分教程 的 PDF 可用于理解案例目的、假设和操作步骤；当前证据还不足以唯一确定物理场，后续应结合 MATLAB/Java 中的 physics.create 或 COMSOL 模型树再确认。
...
- Summary: 已学习 边界网格划分教程 的 11 个文件；训练阶段=needs_comsol_sweep_csv；参数数量=0；内容证据=0 条。
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 边界网格划分教程，训练阶段为 needs_comsol_sweep_csv。
...
- `集群设置验证` score=0.1456; fields=physics, geometry, materials, boundary_conditions, mesh, solver, results; parameters=1
- `使用网格划分序列` score=0.1367; fields=geometry, mesh, applicability; parameters=6

### Official Documentation Checks

- `LiveLinkForMATLABUsersGuide.pdf` page 198; module=LiveLink_for_MATLAB; score=0.115
- `LiveLinkForSimulinkUsersGuide.pdf` page 20; module=LiveLink_for_Simulink; score=0.1133
- `COMSOL_ProgrammingReferenceManual.pdf` page 1196; module=COMSOL_Multiphysics; score=0.1095
