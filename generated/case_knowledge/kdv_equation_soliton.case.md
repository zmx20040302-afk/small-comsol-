...
- Summary: Learned 4 files for kdv_equation_soliton; stage=needs_comsol_sweep_csv; parameters=0.
...
- **6. 记忆库补充**
  - Evidence: 案例标题为 kdv_equation_soliton，训练阶段为 needs_comsol_sweep_csv。
