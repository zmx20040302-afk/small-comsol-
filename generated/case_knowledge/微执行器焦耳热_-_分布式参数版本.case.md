...
- Created at: `2026-07-06T09:39:16.215254+00:00`
...
- `thermal_actuator_jh_distributed.mph`: 参数=3, 几何=2, 物理场=3, 研究=3, 结果=0
- `thermal_actuator_jh_distributed.java`: 参数=3, 几何=2, 物理场=3, 研究=3, 结果=0
- `thermal_actuator_jh_distributed.m`: 参数=3, 几何=2, 物理场=3, 研究=2, 结果=0
...
- `models.mph.thermal_actuator_jh_distributed (1).pdf`: models.mph.thermal_actuator_jh_distributed (1).pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.thermal_actuator_jh_distributed.pdf`: models.mph.thermal_actuator_jh_distributed.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.thermal_actuator_jh_distributed.zh_CN.pdf`: models.mph.thermal_actuator_jh_distributed.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.

## PDF Summary and Physics Judgement

- Simple summary: 微执行器焦耳热 - 分布式参数版本 主要研究温度场和热传递过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Stationary 研究。
...
- 已识别几何证据：imp1 / Import；geom1 / imp1 / filename
- 已识别物理场证据：ec / ConductiveMedia；ht / HeatTransfer；Heat Transfer
- 已识别参数：htc_s、htc_us、DV
...
- Summary: 已学习 微执行器焦耳热 - 分布式参数版本 的 7 个文件；训练阶段=modeling_logic_learning_ready；参数数量=3；内容证据=19 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 19 条；几何=2，物理场=3，材料=1，网格=1，研究=3，结果=0。
