...
- Created at: `2026-08-21T15:26:05.131322+00:00`
...
- 模型树证据数量: 24
- 理论关键词: 传热, 结构力学, 流体, 电磁
- geometry: part1 / Part, part2 / Part, part3 / Part, r1 / Rectangle
...
- `billet_induction_heating.java`: 参数=14, 几何=4, 物理场=0, 研究=0, 结果=0
- `applications.billet_induction_heating.pdf`: 参数=0, 几何=0, 物理场=2, 研究=2, 结果=0
- `billet_induction_heating.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `billet.pptx`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `billet.pdf`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `billet_induction_heating.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `billet_induction_heating_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: billet_induction_heating 主要研究流动速度、压力或输运过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Stationary 研究。
...
- 已识别几何证据：part1 / Part；part2 / Part；part3 / Part；r1 / Rectangle
...
- Summary: 已学习 billet_induction_heating 的 7 个文件；训练阶段=modeling_logic_learning_ready；参数数量=14；内容证据=24 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 24 条；几何=4，物理场=2，材料=0，网格=2，研究=2，结果=0。
  - Judgement: 模型已读取案例内容并抽取 COMSOL 模型树结构，可用于后续自动建模和代码生成。
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：billet_induction_heating.m, billet_induction_heating.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 billet_induction_heating，训练阶段为 modeling_logic_learning_ready。
...
- `billet_induction_heating.mph` (comsol_mph, 74973742 bytes)
- `billet_induction_heating.m` (matlab_livelink, 70897 bytes)
- `billet_induction_heating.java` (comsol_java, 62423 bytes)
- `billet_induction_heating_summary.json` (json, 2803 bytes)
