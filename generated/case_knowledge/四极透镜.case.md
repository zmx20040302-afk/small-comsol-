...
- Created at: `2026-06-29T08:42:25.620939+00:00`
...
- `quadrupole.java`: 参数=9, 几何=20, 物理场=1, 研究=2, 结果=0
- `quadrupole.m`: 参数=9, 几何=20, 物理场=1, 研究=1, 结果=0
- `models.mph.quadrupole.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.quadrupole.zh_CN.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `quadrupole.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 四极透镜 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=9；内容证据=44 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 44 条；几何=20，物理场=1，材料=0，网格=1，研究=2，结果=0。
