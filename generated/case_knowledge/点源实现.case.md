...
- Created at: `2026-06-29T08:46:26.830446+00:00`
...
- `point_source.java`: 参数=0, 几何=2, 物理场=1, 研究=2, 结果=5
- `point_source.m`: 参数=0, 几何=2, 物理场=1, 研究=1, 结果=5
- `models.mph.point_source.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.point_source.zh_CN.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `point_source.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 点源实现 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=20 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 20 条；几何=2，物理场=1，材料=0，网格=1，研究=2，结果=5。
