...
- `biased_resonator_2d_basic.java`: 参数=5, 几何=11, 物理场=0, 研究=0, 结果=0
...
- `biased_resonator_2d_basic_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=3, 结果=0
- `biased_resonator_2d_basic.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `biased_resonator_2d_basic.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: biased_resonator_2d_basic 主要研究结构受力、变形或强度响应，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Solid Mechanics，并采用 Eigenfrequency 研究。
...
- Summary: 已学习 biased_resonator_2d_basic 的 8 个文件；训练阶段=modeling_logic_learning_ready；参数数量=5；内容证据=32 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：biased_resonator_2d_basic.m, biased_resonator_2d_basic.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 biased_resonator_2d_basic，训练阶段为 modeling_logic_learning_ready。
...
- `biased_resonator_2d_basic.mph` (comsol_mph, 3702816 bytes)
- `biased_resonator_2d_basic.m` (matlab_livelink, 23074 bytes)
- `biased_resonator_2d_basic.java` (comsol_java, 20408 bytes)
- `biased_resonator_2d_basic_summary.json` (json, 1149 bytes)
