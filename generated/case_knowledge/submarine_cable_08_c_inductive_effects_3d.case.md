...
- `submarine_cable_08_c_inductive_effects_3d.java`: 参数=17, 几何=0, 物理场=0, 研究=0, 结果=0
...
- `submarine_cable_08_c_inductive_effects_3d.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `submarine_cable_08_c_inductive_effects_3d.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `submarine_cable_08_c_inductive_effects_3d_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Simple summary: submarine_cable_08_c_inductive_effects_3d 主要研究流动速度、压力或输运过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Time Dependent 研究。
...
- Summary: 已学习 submarine_cable_08_c_inductive_effects_3d 的 8 个文件；训练阶段=modeling_logic_learning_ready；参数数量=17；内容证据=23 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：submarine_cable_08_c_inductive_effects_3d.m, submarine_cable_08_c_inductive_effects_3d.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 submarine_cable_08_c_inductive_effects_3d，训练阶段为 modeling_logic_learning_ready。
...
- `submarine_cable_08_c_inductive_effects_3d.mph` (comsol_mph, 630251268 bytes)
- `submarine_cable_08_c_inductive_effects_3d.m` (matlab_livelink, 120955 bytes)
- `submarine_cable_08_c_inductive_effects_3d.java` (comsol_java, 124938 bytes)
- `submarine_cable_08_c_inductive_effects_3d_summary.json` (json, 3430 bytes)
