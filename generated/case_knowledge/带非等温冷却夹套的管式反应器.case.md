...
- Created at: `2026-07-06T09:39:01.972415+00:00`
...
- physics: tds / DilutedSpecies, ht / HeatTransferInFluids, cb / CoefficientFormBoundaryPDE, Heat Transfer, Laminar Flow
- mesh: mesh1
...
- `tubular_reactor.mph`: 参数=20, 几何=2, 物理场=5, 研究=3, 结果=0
- `tubular_reactor.java`: 参数=20, 几何=2, 物理场=3, 研究=3, 结果=0
- `tubular_reactor.m`: 参数=19, 几何=2, 物理场=3, 研究=2, 结果=0
- `tubular_reactor_parameters.zh_CN.txt`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `tubular_reactor_parameters.txt`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `tubular_reactor_variables.txt`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `tubular_reactor_variables.zh_CN.txt`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
...
- `applications.tubular_reactor.pdf`: applications.tubular_reactor.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `applications.tubular_reactor.zh_CN.pdf`: applications.tubular_reactor.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.tubular_reactor.pdf`: models.mph.tubular_reactor.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.
- `models.mph.tubular_reactor.zh_CN.pdf`: models.mph.tubular_reactor.zh_CN.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果；核心内容可概括为：PDF detected. Text extraction requires pypdf or pdfplumber.

## PDF Summary and Physics Judgement

- Simple summary: 带非等温冷却夹套的管式反应器 主要研究流动速度、压力或输运过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Laminar Flow，并采用 Stationary 研究。
...
- 脚本/文本识别到的物理场: tds / DilutedSpecies, ht / HeatTransferInFluids, cb / CoefficientFormBoundaryPDE, Heat Transfer, Laminar Flow
...
- 已识别物理场证据：tds / DilutedSpecies；ht / HeatTransferInFluids；cb / CoefficientFormBoundaryPDE；Heat Transfer；Laminar Flow
...
- Transfer recognized physics interfaces to similar requirements: tds / DilutedSpecies, ht / HeatTransferInFluids, cb / CoefficientFormBoundaryPDE, Heat Transfer, Laminar Flow.
...
- Summary: 已学习 带非等温冷却夹套的管式反应器 的 13 个文件；训练阶段=modeling_logic_learning_ready；参数数量=26；内容证据=39 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 39 条；几何=2，物理场=5，材料=0，网格=1，研究=3，结果=0。
