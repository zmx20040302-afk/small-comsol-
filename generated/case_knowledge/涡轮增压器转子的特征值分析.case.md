...
- Created at: `2026-06-29T08:46:06.885365+00:00`
...
- `turbocharger_rotor.java`: 参数=0, 几何=0, 物理场=1, 研究=2, 结果=0
- `turbocharger_rotor.m`: 参数=0, 几何=0, 物理场=1, 研究=1, 结果=0
...
- `turbocharger_rotor.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 涡轮增压器转子的特征值分析 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=18 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 18 条；几何=0，物理场=1，材料=1，网格=5，研究=2，结果=0。
