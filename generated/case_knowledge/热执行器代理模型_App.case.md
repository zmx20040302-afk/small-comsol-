...
- Created at: `2026-06-29T08:46:46.906050+00:00`
...
- `thermal_actuator_surrogate.java`: 参数=0, 几何=0, 物理场=3, 研究=2, 结果=0
- `thermal_actuator_surrogate.m`: 参数=0, 几何=0, 物理场=3, 研究=1, 结果=0
...
- `thermal_actuator_surrogate.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 热执行器代理模型 App 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=7 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 7 条；几何=0，物理场=3，材料=1，网格=1，研究=2，结果=0。
