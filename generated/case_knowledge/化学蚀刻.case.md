...
- Created at: `2026-06-29T08:41:54.938412+00:00`
...
- `chemical_etching.m`: 参数=10, 几何=3, 物理场=2, 研究=1, 结果=0
- `chemical_etching.java`: 参数=10, 几何=2, 物理场=2, 研究=2, 结果=0
- `chemical_etching.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 化学蚀刻 的 8 个文件；训练阶段=modeling_logic_learning_ready；参数数量=10；内容证据=29 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 29 条；几何=3，物理场=2，材料=0，网格=1，研究=2，结果=0。
