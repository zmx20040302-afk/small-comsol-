...
- `models.mph.stl_1_repair_imported_meshes.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.mph.stl_2_combine_geom_mesh.pdf`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `polyaxial_screw_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `stl_1_repair_imported_meshes.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `stl_1_repair_imported_meshes.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `stl_2_combine_geom_mesh.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `stl_2_combine_geom_mesh.zh_CN.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `stl_2_combine_geom_mesh_parameters.txt`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 STL导入教程 的 11 个文件；训练阶段=needs_comsol_sweep_csv；参数数量=15；内容证据=0 条。
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 STL导入教程，训练阶段为 needs_comsol_sweep_csv。
...
- `管式反应器代理模型 App` score=0.1734; fields=physics, geometry, materials, boundary_conditions, mesh, solver, results, applicability; parameters=86
- `集群设置验证` score=0.146; fields=physics, geometry, materials, boundary_conditions, mesh, solver, results; parameters=1
- `热执行器代理模型 App` score=0.1341; fields=physics, geometry, materials, boundary_conditions, mesh, solver, results; parameters=42

### Official Documentation Checks

- `CFDModuleUsersGuide.pdf` page 292; module=CFD_Module; score=0.1508
- `LiveLinkForMATLABUsersGuide.pdf` page 62; module=LiveLink_for_MATLAB; score=0.133
- `LiveLinkForMATLABUsersGuide.pdf` page 63; module=LiveLink_for_MATLAB; score=0.1221
