...
- Created at: `2026-07-06T09:42:07.922084+00:00`
...
- `laser_heating_wafer_state_variable_emissivity_v63.mph`: 参数=7, 几何=7, 物理场=1, 研究=2, 结果=0
- `laser_heating_wafer_state_variable_MaxT_v63.java`: 参数=7, 几何=7, 物理场=1, 研究=2, 结果=0
- `laser_heating_wafer_state_variable_MaxT_v63.mph`: 参数=7, 几何=7, 物理场=1, 研究=2, 结果=0
...
- Simple summary: 状态变量6.3 主要研究模型中的主要物理现象和输出量，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer，并采用 Transient 研究。
