...
- Created at: `2026-06-29T08:50:54.740896+00:00`
...
- `tuning_fork_time_and_hardware_limited.java`: 参数=4, 几何=20, 物理场=1, 研究=2, 结果=0
- `tuning_fork_time_and_hardware_limited.m`: 参数=4, 几何=20, 物理场=1, 研究=1, 结果=0
- `tuning_fork_time_and_hardware_limited.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 限时和硬件锁定的 App 的 3 个文件；训练阶段=modeling_logic_learning_ready；参数数量=4；内容证据=54 条。
