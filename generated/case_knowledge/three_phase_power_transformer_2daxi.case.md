# three_phase_power_transformer_2daxi

- Case directory: `D:\桌面\codex\案例下载\电气\三相电力变压器损耗的计算`
- Training stage: `modeling_logic_learning_ready`
- Created at: `2026-08-22T04:20:15.885725+00:00`
...
- `Prm_hc` = `3.7[mm]` - Primario, altezza conduttori
- `Prm_wc` = `2.3[mm]` - Primario, larghezza conduttori
- `Prm_Nspst` = `50` - Primario, numero spire per strato
- `Prm_Nst1` = `8` - Primario, numero strati primo blocco
- `Prm_Nst2` = `6` - Primario, numero strati secondo blocco
- `Prm_Nst` = `Prm_Nst1+Prm_Nst2` - Primario, numero strati totale
- `Prm_Nc` = `1` - Primario, numero conduttori per spira
- `Prm_N` = `Prm_Nspst*Prm_Nst -7` - Primario, numero totale spire
- `Scn_hc` = `12[mm]` - Secondario, altezza conduttori
- `Scn_wc` = `3.5[mm]` - Secondario, larghezza conduttori
- `Scn_Nspst` = `8` - Secondario, numero spire per strato
- `Scn_Nc` = `Scn_Nc1*Scn_Nc2` - Secondario, numero conduttori per spira
- `Scn_Nc1` = `2` - Secondario, numero conduttori per spira, direzione r
- `Scn_Nc2` = `2` - Secondario, numero conduttori per spira, direzione z
- `Scn_Nst` = `4` - Secondario, numero strati
- `Scn_N` = `Scn_Nspst*Scn_Nst` - Secondario, numero totale spire
- `h0` = `2.8[cm]`
- `h1` = `10[cm]`
- `h2` = `Scn_htot`
- `h3` = `2[cm]`
- `h4` = `Prm_htot`
- `h5` = `(Scn_htot-Prm_htot)/2`
- `htot` = `h0+h1+h2+h3+h2+h1+h0`
- `w0` = `10.25[cm]`
- `w1` = `4[cm]`
- `w2` = `wtot2`
- `w3` = `1[cm]`
...
- `three_phase_power_transformer_2daxi.java`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `Computation_losses_in_three_phase_power_transformer.pptx`: 参数=0, 几何=0, 物理场=0, 研究=1, 结果=0
- `three_phase_power_transformer_2daxi.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `three_phase_power_transformer_2daxi.m`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `three_phase_power_transformer_2daxi_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0

## PDF Summary and Physics Judgement

- Simple summary: three_phase_power_transformer_2daxi 的 PDF 可用于理解案例目的、假设和操作步骤；当前证据还不足以唯一确定物理场，后续应结合 MATLAB/Java 中的 physics.create 或 COMSOL 模型树再确认。
...
- PDF keywords: 电磁, 多孔介质/裂隙
- `Prm_hc` -> Primario, altezza conduttori; MATLAB: `model.param.set('Prm_hc', value, description)`
- `Prm_wc` -> Primario, larghezza conduttori; MATLAB: `model.param.set('Prm_wc', value, description)`
- `Prm_Nspst` -> Primario, numero spire per strato; MATLAB: `model.param.set('Prm_Nspst', value, description)`
- `Prm_Nst1` -> Primario, numero strati primo blocco; MATLAB: `model.param.set('Prm_Nst1', value, description)`
- `Prm_Nst2` -> Primario, numero strati secondo blocco; MATLAB: `model.param.set('Prm_Nst2', value, description)`
- `Prm_Nst` -> Primario, numero strati totale; MATLAB: `model.param.set('Prm_Nst', value, description)`
- `Prm_Nc` -> Primario, numero conduttori per spira; MATLAB: `model.param.set('Prm_Nc', value, description)`
- `Prm_N` -> Primario, numero totale spire; MATLAB: `model.param.set('Prm_N', value, description)`
- `Scn_hc` -> Secondario, altezza conduttori; MATLAB: `model.param.set('Scn_hc', value, description)`
- `Scn_wc` -> Secondario, larghezza conduttori; MATLAB: `model.param.set('Scn_wc', value, description)`
- `Scn_Nspst` -> Secondario, numero spire per strato; MATLAB: `model.param.set('Scn_Nspst', value, description)`
- `Scn_Nc` -> Secondario, numero conduttori per spira; MATLAB: `model.param.set('Scn_Nc', value, description)`
...
- 已识别参数：Prm_hc、Prm_wc、Prm_Nspst、Prm_Nst1、Prm_Nst2、Prm_Nst、Prm_Nc、Prm_N、Scn_hc、Scn_wc、Scn_Nspst、Scn_Nc
...
- Sweep `Prm_hc` around the learned value `3.7[mm]` and export target outputs to CSV.
- Sweep `Prm_wc` around the learned value `2.3[mm]` and export target outputs to CSV.
- Sweep `Prm_Nspst` around the learned value `50` and export target outputs to CSV.
- Sweep `Prm_Nst1` around the learned value `8` and export target outputs to CSV.
- Sweep `Prm_Nst2` around the learned value `6` and export target outputs to CSV.
- Sweep `Prm_Nst` around the learned value `Prm_Nst1+Prm_Nst2` and export target outputs to CSV.
- Sweep `Prm_Nc` around the learned value `1` and export target outputs to CSV.
- Sweep `Prm_N` around the learned value `Prm_Nspst*Prm_Nst -7` and export target outputs to CSV.
...
- Summary: 已学习 three_phase_power_transformer_2daxi 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=31；内容证据=31 条。
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：three_phase_power_transformer_2daxi.m, three_phase_power_transformer_2daxi.java
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 three_phase_power_transformer_2daxi，训练阶段为 modeling_logic_learning_ready。
...
- `three_phase_power_transformer_2daxi.mph` (comsol_mph, 83140230 bytes)
- `three_phase_power_transformer_2daxi.m` (matlab_livelink, 97026 bytes)
- `three_phase_power_transformer_2daxi.java` (comsol_java, 95788 bytes)
- `three_phase_power_transformer_2daxi_summary.json` (json, 38808 bytes)
- `Computation_losses_in_three_phase_power_transformer.pptx` (presentation_document, 6886103 bytes)
