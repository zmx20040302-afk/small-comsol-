...
- Created at: `2026-06-29T08:47:30.756523+00:00`
...
- `electric_sensor_batch_sweep.java`: 参数=0, 几何=9, 物理场=1, 研究=2, 结果=0
- `electric_sensor_batch_sweep.m`: 参数=0, 几何=9, 物理场=1, 研究=1, 结果=0
- `electric_sensor_batch_sweep.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 电传感器批处理扫描 的 3 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=26 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 26 条；几何=9，物理场=1，材料=0，网格=1，研究=2，结果=0。
