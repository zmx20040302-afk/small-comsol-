...
- Created at: `2026-06-29T08:42:02.554077+00:00`
...
- `loaded_spring.java`: 参数=1, 几何=3, 物理场=1, 研究=2, 结果=0
- `loaded_spring.m`: 参数=1, 几何=3, 物理场=1, 研究=1, 结果=0
- `loaded_spring.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 受载弹簧 - 使用全局方程满足约束条件 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=1；内容证据=19 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 19 条；几何=3，物理场=1，材料=1，网格=1，研究=2，结果=0。
