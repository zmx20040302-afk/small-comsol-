...
- Created at: `2026-06-29T08:42:14.386473+00:00`
...
- physics: c / CoefficientFormPDE, c2 / CoefficientFormPDE
- mesh: mesh1, mesh2
- studies: std1 / eigv / Eigenvalue, std2 / eigv / Eigenvalue, std1, std2
- results: pg1, surf1
- boundary_conditions: pol1 / source, surf1 / expr

### 文件内容证据

- `isospectral_drums.java`: 参数=0, 几何=3, 物理场=2, 研究=4, 结果=2
- `isospectral_drums.m`: 参数=0, 几何=3, 物理场=2, 研究=2, 结果=2
- `isospectral_drums.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 同频鼓 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=15 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 15 条；几何=3，物理场=2，材料=0，网格=2，研究=4，结果=2。
