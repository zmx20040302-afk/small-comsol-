...
- Created at: `2026-06-29T08:49:37.511921+00:00`
...
- `diffraction_patterns.java`: 参数=3, 几何=11, 物理场=1, 研究=2, 结果=2
- `diffraction_patterns.m`: 参数=3, 几何=11, 物理场=1, 研究=1, 结果=2
- `diffraction_patterns.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 衍射图样 的 6 个文件；训练阶段=modeling_logic_learning_ready；参数数量=3；内容证据=38 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 38 条；几何=11，物理场=1，材料=0，网格=4，研究=2，结果=2。
