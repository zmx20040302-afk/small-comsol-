# microlithography_lens_geom_sequence

- Case directory: `D:\桌面\codex\案例下载\电气\微光刻透镜`
- Training stage: `modeling_logic_learning_ready`
- Created at: `2026-08-22T08:34:32.590969+00:00`
...
- `T_0` = `107.954[mm]` - Surface 0  thickness
- `T_1` = `30.375[mm]` - Surface 1  thickness
- `T_2` = `0.934[mm]` - Surface 2  thickness
- `T_3` = `68.636[mm]` - Surface 3  thickness
- `T_4` = `0.865[mm]` - Surface 4  thickness
- `T_5` = `7.061[mm]` - Surface 5  thickness
- `T_6` = `15.608[mm]` - Surface 6  thickness
- `T_7` = `6.952[mm]` - Surface 7  thickness
- `T_8` = `30.983[mm]` - Surface 8  thickness
- `T_9` = `11.541[mm]` - Surface 9  thickness
- `T_10` = `33.165[mm]` - Surface 10 thickness
- `T_11` = `11.524[mm]` - Surface 11 thickness
- `T_12` = `9.159[mm]` - Surface 12 thickness
- `T_13` = `36.703[mm]` - Surface 13 thickness
- `T_14` = `0.889[mm]` - Surface 14 thickness
- `T_15` = `41.168[mm]` - Surface 15 thickness
- `T_16` = `0.883[mm]` - Surface 16 thickness
- `T_17` = `26.903[mm]` - Surface 17 thickness
- `T_18` = `0.883[mm]` - Surface 18 thickness
- `T_19` = `21.883[mm]` - Surface 19 thickness
- `T_20` = `0.883[mm]` - Surface 20 thickness
- `T_21` = `22.715[mm]` - Surface 21 thickness
- `T_22` = `67.972[mm]` - Surface 22 thickness
- `T_23` = `8.386[mm]` - Surface 23 thickness
- `T_24` = `23.616[mm]` - Surface 24 thickness
- `T_25` = `11.034[mm]` - Surface 25 thickness
- `T_26` = `58.171[mm]` - Surface 26 thickness
- `T_27` = `11.343[mm]` - Surface 27 thickness
- `T_28` = `11.371[mm]` - Surface 28 thickness
- `T_29` = `22.211[mm]` - Surface 29 thickness
- `T_30` = `1.323[mm]` - Surface 30 thickness
- `T_31` = `39.484[mm]` - Surface 31 thickness
- `T_32` = `0.883[mm]` - Surface 32 thickness
- `T_33` = `37.168[mm]` - Surface 33 thickness
- `T_34` = `0.883[mm]` - Surface 34 thickness
- `T_35` = `31.600[mm]` - Surface 35 thickness
- `T_36` = `0.883[mm]` - Surface 36 thickness
- `T_37` = `27.885[mm]` - Surface 37 thickness
- `T_38` = `0.884[mm]` - Surface 38 thickness
- `T_39` = `73.045[mm]` - Surface 39 thickness
- `T_40` = `54.069[mm]` - Surface 40 thickness
- `T_41` = `16.956[mm]` - Surface 41 thickness
- `T_42` = `13.168[mm]` - Surface 42 thickness
- `T_43` = `0.0[mm]` - Surface 43 thickness
...
- `microlithography_lens_geom_sequence.m`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `microlithography_lens_geom_sequence.java`: 参数=20, 几何=0, 物理场=0, 研究=0, 结果=0
- `models.roptics.microlithography_lens.pdf`: 参数=0, 几何=0, 物理场=1, 研究=0, 结果=0
- `microlithography_lens_geom_sequence.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
- `microlithography_lens_geom_sequence_summary.json`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0

## 每个 PDF 文件的简单总结

- `models.roptics.microlithography_lens.pdf`: models.roptics.microlithography_lens.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果，主要物理场线索为 Ray Optics；核心内容可概括为：Model created in COMSOL Multiphysics 6.4；This tutorial demonstrates how to perform geometrical optics simulation in a 21-element

## PDF Summary and Physics Judgement

- Simple summary: microlithography_lens_geom_sequence 主要研究温度场和热传递过程，PDF 用来说明问题目标、基本假设和求解对象；从核心内容看，建模时应优先选择 Heat Transfer。
...
- PDF: This tutorial demonstrates how to perform geometrical optics simulation in a 21-element
- PDF: The geometry is constructed using parts from the Ray Optics Module Part Library. All of
- PDF: When constructing a geometry in COMSOL to be used in a Geometrical Optics ray trace,
...
- PDF keywords: 传热, 结构力学, 电磁, models.roptics.microlithography_lens.pdf: 该 PDF 主要用于说明案例背景、建模目标、理论假设和验证结果，主要物理场线索为 Ray Optics；核心内容可概括为：Model created in COMSOL Multiphysics 6.4；This tutorial demonstrates how to perform geometrical optics simulation in a 21-element
- `T_0` -> Surface 0  thickness; MATLAB: `model.param.set('T_0', value, description)`
- `T_1` -> Surface 1  thickness; MATLAB: `model.param.set('T_1', value, description)`
- `T_2` -> Surface 2  thickness; MATLAB: `model.param.set('T_2', value, description)`
- `T_3` -> Surface 3  thickness; MATLAB: `model.param.set('T_3', value, description)`
- `T_4` -> Surface 4  thickness; MATLAB: `model.param.set('T_4', value, description)`
- `T_5` -> Surface 5  thickness; MATLAB: `model.param.set('T_5', value, description)`
- `T_6` -> Surface 6  thickness; MATLAB: `model.param.set('T_6', value, description)`
- `T_7` -> Surface 7  thickness; MATLAB: `model.param.set('T_7', value, description)`
- `T_8` -> Surface 8  thickness; MATLAB: `model.param.set('T_8', value, description)`
- `T_9` -> Surface 9  thickness; MATLAB: `model.param.set('T_9', value, description)`
- `T_10` -> Surface 10 thickness; MATLAB: `model.param.set('T_10', value, description)`
- `T_11` -> Surface 11 thickness; MATLAB: `model.param.set('T_11', value, description)`
...
- 已识别物理场证据：Ray Optics
- 已识别参数：T_0、T_1、T_2、T_3、T_4、T_5、T_6、T_7、T_8、T_9、T_10、T_11
...
- 本案例已提取 44 个参数，可作为约束 JSON 和参数扫描变量。
...
- Sweep `T_0` around the learned value `107.954[mm]` and export target outputs to CSV.
- Sweep `T_1` around the learned value `30.375[mm]` and export target outputs to CSV.
- Sweep `T_2` around the learned value `0.934[mm]` and export target outputs to CSV.
- Sweep `T_3` around the learned value `68.636[mm]` and export target outputs to CSV.
- Sweep `T_4` around the learned value `0.865[mm]` and export target outputs to CSV.
- Sweep `T_5` around the learned value `7.061[mm]` and export target outputs to CSV.
- Sweep `T_6` around the learned value `15.608[mm]` and export target outputs to CSV.
- Sweep `T_7` around the learned value `6.952[mm]` and export target outputs to CSV.
...
- Summary: 已学习 microlithography_lens_geom_sequence 的 5 个文件；训练阶段=modeling_logic_learning_ready；参数数量=44；内容证据=31 条。
...
- 44 extracted parameters with values/descriptions.
...
- **3. 建模脚本识别**
  - Evidence: 检测到可复用的 MATLAB/Java 建模脚本：microlithography_lens_geom_sequence.m, microlithography_lens_geom_sequence.java
  - Judgement: 脚本中的 COMSOL API 调用可用于恢复模型树顺序，并辅助生成 LiveLink MATLAB 自动建模脚本。
- **4. 参数与约束提取**
  - Evidence: 从文本、MATLAB 或 Java 证据中提取到 44 个参数。
...
- **7. 记忆库补充**
  - Evidence: 案例标题为 microlithography_lens_geom_sequence，训练阶段为 modeling_logic_learning_ready。
...
- `microlithography_lens_geom_sequence.mph` (comsol_mph, 24231791 bytes)
- `microlithography_lens_geom_sequence.m` (matlab_livelink, 83854 bytes)
- `microlithography_lens_geom_sequence.java` (comsol_java, 87899 bytes)
- `microlithography_lens_geom_sequence_summary.json` (json, 4090 bytes)
- `models.roptics.microlithography_lens.pdf` (pdf_document, 693850 bytes)
