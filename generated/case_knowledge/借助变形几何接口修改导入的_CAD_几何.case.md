...
- Created at: `2026-06-29T08:41:44.198367+00:00`
...
- `deformed_geometry_wrench_62.java`: 参数=0, 几何=1, 物理场=1, 研究=1, 结果=0
- `deformed_geometry_wrench_62.m`: 参数=0, 几何=1, 物理场=1, 研究=0, 结果=0
- `deformed_geometry_wrench_62.mph`: 参数=0, 几何=0, 物理场=0, 研究=0, 结果=0
...
- Summary: 已学习 借助变形几何接口修改导入的 CAD 几何 的 3 个文件；训练阶段=modeling_logic_learning_ready；参数数量=0；内容证据=6 条。
...
- **2. 内容级模型树抽取**
  - Evidence: 抽取到模型树证据 6 条；几何=1，物理场=1，材料=1，网格=1，研究=1，结果=0。
