function model = model_100_mm__50_mm___20260812103104()
%MODEL_100_MM__50_MM___20260812103104 Memory-assisted COMSOL LiveLink builder.
...
model.label('model_100_mm__50_mm___20260812103104.mph');
...
model.study('std1').feature('param').set('plistarr', {'range(1[V],1[V],5[V])'});
