function model = joule_rectangle_auto_solve()
%JOULE_RECTANGLE_AUTO_SOLVE Memory-assisted COMSOL LiveLink builder.
...
model.label('joule_rectangle_auto_solve.mph');
...
model.param.set('H', '0.41[m]', '圆柱绕流');
model.param.set('W', '1[m]', '圆柱绕流');
model.param.set('R', '0.05[m]', '圆柱绕流');
model.param.set('U_mean', '1[m/s]', '圆柱绕流');
