...
public class Model100Mm50Mm20260814021633 {
  public static Model run() {
    ...
    // Bind ElectricPotential(Vtot), Ground, and ConvectiveHeatFlux(htc,T_amb) to those verified selections.
    ...
    model.study("std1").feature("param").set("plistarr", new String[]{"range(1[V],1[V],5[V])"});
  ...
  public static void main(String[] args) {
    Model model = run();
    model.save("model_100_mm__50_mm___20260814021633.mph");
  }
}
