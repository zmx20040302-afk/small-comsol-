function model = model_100_mm__50_mm___20260814021633()
%MODEL_100_MM__50_MM___20260814021633 Memory-assisted COMSOL LiveLink builder.
...
model.label('model_100_mm__50_mm___20260814021633.mph');
...
% REVIEW REQUIRED: assign verified boundary IDs to sel_terminal, sel_ground, and sel_convection before enabling physics features.
% model.component('comp1').physics('ec').create('pot1', 'ElectricPotential', 2); % set V0=Vtot on sel_terminal.
% model.component('comp1').physics('ec').create('gnd1', 'Ground', 2); % set on sel_ground.
% model.component('comp1').physics('ht').create('hf1', 'HeatFluxBoundary', 2); % set h=htc and Text=T_amb on sel_convection.
